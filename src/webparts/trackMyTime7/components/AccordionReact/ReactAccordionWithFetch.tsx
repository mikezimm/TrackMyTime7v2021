/**
 * This is the original .tsx file from the sample below by Hugo Bernier.
 * Copied from https://github.com/pnp/sp-dev-fx-webparts/tree/master/samples/react-accordion-dynamic-section
 * Commented so it does not cause errors
 * 
 */
